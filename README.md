...
| :--- | :--- |
| **Machine Learning** | Supervised/Unsupervised Learning, Deep Learning Architectures (CNNs, Transformers), Optimization. |
| **Computer Vision** | Multiple View Geometry, Object Detection & Segmentation, Optical Flow Estimation. |
| **Preference Learning** | Learning to Rank (Pointwise/Pairwise/Listwise), RLHF (Reinforcement Learning from Human Feedback) |
| **IT Security** | Cryptography (AES, RSA), Binary Analysis, Memory Safety (Buffer Overflows, Heap Exploits), Network Security Protocols. |
| **Software Testing** | Automated Test Generation, Fuzzing, Symbolic Execution, CI/CD Integration, Formal Verification Methods. |
...
| [![Google Font Finder](https://github-readme-stats.vercel.app/api/pin/?username=yv3nne&repo=google-font-finder&theme=transparent&hide_border=true)](https://github.com/yv3nne/google-font-finder) | [![AutoParam Model](https://github-readme-stats.vercel.app/api/pin/?username=yv3nne&repo=autoparam-model&theme=transparent&hide_border=true)](https://github.com/yv3nne/autoparam-model) |
